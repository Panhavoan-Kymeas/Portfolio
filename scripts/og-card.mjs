...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="140" y="203" font-family="DejaVu Sans Mono, monospace" font-size="20" fill="${accent}" letter-spacing="3">DEVELOPER &#183; LIFELONG LEARNER</text>
  ...
  <!-- tagline -->
  <text x="90" y="510" font-family="DejaVu Sans, sans-serif" font-size="27" fill="${muted}">I build useful things for the web and write</text>
  <text x="90" y="548" font-family="DejaVu Sans, sans-serif" font-size="27" fill="${muted}">about what I learn along the way.</text>
